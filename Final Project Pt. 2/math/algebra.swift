...
//                      Spacer()
                ...
                VStack(spacing: 30) {
                    ...
                    NavigationLink(destination: alg_creations()) {
                        Text("New Creations")
                    ...
                    NavigationLink(destination: alg_female()) {
                        Text("Female Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
                    ...
                    NavigationLink(destination: alg_bipoc()) {
                        Text("BIPOC Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
...
struct algebra_Previews: PreviewProvider {
