...
//                      Spacer()
                ...
                VStack(spacing: 30) {
                    ...
                    NavigationLink(destination: calc_creations()) {
                        Text("New Creations")
                    ...
                    NavigationLink(destination: calc_female()) {
                        Text("Female Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
                    ...
                    NavigationLink(destination: calc_bipoc()) {
                        Text("BIPOC Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
...
struct calculus_Previews: PreviewProvider {
