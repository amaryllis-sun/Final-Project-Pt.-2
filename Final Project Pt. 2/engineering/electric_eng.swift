...
//                      Spacer()
                ...
                VStack(spacing: 30) {
                    ...
                    NavigationLink(destination: elec_creations()) {
                        Text("New Creations")
                    ...
                    NavigationLink(destination: elec_female()) {
                        Text("Female Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
                    ...
                    NavigationLink(destination: elec_bipoc()) {
                        Text("BIPOC Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
...
struct electric_eng_Previews: PreviewProvider {
