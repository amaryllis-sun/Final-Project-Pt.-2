...
//                      Spacer()
                ...
                VStack(spacing: 30) {
                    ...
                    NavigationLink(destination: vr_creations()) {
                        Text("New Creations")
                    ...
                    NavigationLink(destination: vr_female()) {
                        Text("Female Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
                    ...
                    NavigationLink(destination: vr_bipoc()) {
                        Text("BIPOC Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
...
struct virtual_reality_Previews: PreviewProvider {
