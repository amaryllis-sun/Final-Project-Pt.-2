...
//                      Spacer()
                ...
                VStack(spacing: 30) {
                    ...
                    NavigationLink(destination: cyber_creations()) {
                        Text("New Creations")
                    ...
                    NavigationLink(destination: cyber_female()) {
                        Text("Female Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
                    ...
                    NavigationLink(destination: cyber_bipoc()) {
                        Text("BIPOC Focus")
                            .foregroundColor(.black)
                            .font(.custom("Georgia", size: 25))
                            .padding()
...
struct cybersecurity_Previews: PreviewProvider {
